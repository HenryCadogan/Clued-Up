...
git clone -b gh-pages https://$GH_REPO_TOKEN@$WEB_REPO_REF

cd Clued-Up-Documentation


##### Configure git.
# Set the push default to simple i.e. push only the current branch.
git config --global push.default simple
git config user.name "Henry Cadogan"
git config user.email "hgc509@york.ac.uk"
